    ...
    <div class="user__sidebar">
        ...
        <div class="sidebar__user-menu">
            <ul class="sidebar__user-menu-list">
                ...
                <li class="sidebar__menu-element">
                    <a href="index.php?page=reservation" class="menu__list-element-ref user__icone-active">
    ...
    <div class="user__main-content">
        <div class="container__user-page">
            <div class="user__content-header-wrapper">
                <h1 class="user__content-heading">Mes Réservations</h1>
            </div>
            <div class="user__reservation-information">
                <div class="user__reservation-element">
                    <div class="reservation__element-heading-wrapper">
                        <h3 class="reservation__element-heading">Tournois P1000</h3>
                    </div>
                    <div class="reservation__element-content">
                        <div class="reservation__element-element">
                            <h4 class="reservation__element-element-heading">Date :</h4>
                            <p class="reservation__element-date">
                                Dimanche 13 Avril 2025 à 15h00
                            </p>
                        </div>
                        <div class="reservation__element-element">
                            <h4 class="reservation__element-element-heading">
                                Localisation :
                            </h4>
                            <p class="reservation__element-location">
                                5 Padel club, Nancy
                            </p>
                        </div>
                        <div class="reservation__element-element">
                            <h4 class="reservation__element-element-heading">Place :</h4>
                            <p class="reservation__element-placement">
                        ...
                        <div class="reservation__element-element">
                            ...
                            <p class="reservation__element-teams">
                                Les Trois Feuilles, Les Démons, Les Bomboclatz Réactives
                            </p>
                        </div>
                    </div>
                    <div class="reservation__element-modification">
                        <a href="#" class="reservation__element-modification-btn">Modifier</a>
                    </div>
                </div>
                <div class="user__reservation-element">
                    <div class="reservation__element-heading-wrapper">
