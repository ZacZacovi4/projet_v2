    ...
    <div class="user__sidebar">
        ...
        <div class="sidebar__user-menu">
            <ul class="sidebar__user-menu-list">
                ...
                <li class="sidebar__menu-element">
                    <a href="index.php?page=friend" class="menu__list-element-ref user__icone-active">
    ...
    <div class="user__main-content">
        <div class="container__user-page">
            <div class="user__content-header-wrapper">
                <h1 class="user__content-heading">Mes Amis</h1>
            </div>
            <div class="user__friends-information">
                <div class="user__friend-element">
                    <div class="friend__element-photo-wrapper">
                        <img src="assets/images/photo_player_1.avif" alt="" class="friend__element-photo" />
                    </div>
                    <div class="friend__element-description">
                        <h3 class="friend__element-name">John</h3>
                        <h3 class="friend__element-surname">Doe</h3>
                    </div>
